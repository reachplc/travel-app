    ...
    grunt.initConfig({
        ...
        copy: {
            ...
            bower: {
                files: [{
                    expand: true,
                    cwd: '<%= dir.includes %>/bower_components/jquery/',
                    src: ['jquery.min.js'],
                    dest: '<%= dir.build %>/static/js/lib/'
                }]
            }
        }
        ...
        autoprefixer: {
            options: {
                browsers: [
                    'last 2 versions', 'ie 8', 'ie 9', 'Android >= 4', 'BlackBerry 7', 'BlackBerry >= 10'
                ],
            },
            files: {
